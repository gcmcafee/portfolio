  ...
  return (
    <div>
      ...
      <main id="main" className="main">
        <section
          id="hello"
          className="hello min-vh-lg-80 d-flex align-items-center bg-secondary text-white"
          data-overlay="7g"
        >
          ...
          <div className="pt-6 pb-5 pt-md-7 pb-md-6 container-fluid content">
            ...
            <p className="lead mb-4 mb-sm-5 ml-3">
              UX-minded front end development with a focus on fluid,
              lightweight and intuitive web experiences.
              {/* Currently, I’m focused on  building accessible, human-centered products with <a href="https://www.1011i.com/" className="text-white">Teneleven Interactive</a>. */}
            </p>
            <a
        ...
        <section
          id="work"
          className="work min-vh-lg-80 d-flex align-items-center position-relative overflow-hidden"
        >
          <div className="title-wrapper">
          ...
          <div className="py-5 pt-lg-7 w-100">
            ...
            <div className="work-body d-flex justify-content-center">
              ...
              <div className="swiper-container swiper--carousel--work">
                    ...
                    <div className="swiper-slide-inner">
                      <div className="content content--foresight w-100 d-lg-flex {{ position-relative}}">
                        <div
                          ...
                          // style={{'--aspect-ratio':'1056/606'}}
                        >
                          <div className="image-set"></div>
                        </div>
                        <div className="text mt-3 m-4 mt-lg-4 m-xl-5 d-flex flex-column order-first">
                          <h2>Foresight Sports</h2>
                          <p className="lead mb-4">
                            Makers of the world’s most advanced and trusted
                            golf launch monitors, simulators, and range
                            solutions – including the
                            award‑winning&nbsp;GCQuad™.
                          </p>
                    ...
                    <div className="swiper-slide-inner">
                      <div className="content content--flagship w-100 d-lg-flex {{ position-relative}}">
                        {/* <div
                          ...
                          style="--aspect-ratio:1056/606;"
                        > */}
                        <div className="images mt-4 mt-lg-0  d-flex justify-content-center align-items-center flex-fill w-100">
                          <div className="image-set"></div>
                        </div>
                        <div className="text mt-3 m-4 mt-lg-4 m-xl-5 d-flex flex-column order-first">
                          ...
                          <p className="lead mb-4">
                            ...
                            Diego’s only locally - and family-owned yacht
                            charter, cruise, and event company.
                          </p>
                          <div className="tech mt-auto mb-3">
                            <h3 className="h5 mb-3">
                              Front End Development, UX&nbsp;Development
                    ...
                    <div className="swiper-slide-inner">
                      <div className="content content--georges w-100 d-lg-flex {{ position-relative}}">
                        ...
                        <div className="text mt-3 m-4 mt-lg-4 m-xl-5 d-flex flex-column order-first">
                          ...
                          <p className="lead mb-4">
                            George’s at the Cove is an award-winning
                            three-level dining destination located in the
                            heart of La Jolla overlooking the Pacific Ocean.
                          </p>
                          <div className="tech mt-auto mb-3">
                            <h3 className="h5 mb-3">
                              Front End Development, UX&nbsp;Development
        ...
        <section
          id="about"
          className="about min-vh-lg-80 d-flex align-items-center position-relative"
          style={{ border: '#999999' }}
        >
          <div className="title-wrapper">
            <h2 className="title position-absolute rotate">About</h2>
          </div>
          <div className="py-6 pb-lg-7 container-fluid content">
            <div className="row flex-column flex-lg-row align-items-center justify-content-center">
              ...
              <div className="col d-flex justify-content-center">
                <div className="text">
                  <h2 className="h1 mb-4">A Bit About Myself</h2>
                  <p className="lead mb-4">
                    I’m a Front End Developer and UX advocate with over
                    10&nbsp;years experience in the field. Through freelance
                    and agency work, I’ve had the pleasure of working with a
                    great deal of people and organizations on a wide variety
                    of projects. Originally from Seattle, I lived in Phoenix
                    for 5 years before relocating to San Diego. Beyond the web
                    I’m a big fan of off-roading, gardening and the
        ...
        {clients.length > 0 && (
          <ul>
            {clients.map((client) => (
              <li key={client._id}>{client?.alt}</li>
            ))}
          </ul>
        )} 
        <section
          id="clients"
          className="clients bg-white position-relative overflow-hidden py-3"
        >
          <div className="title-wrapper">
            <h2 className="title rotate">Clients</h2>
          </div>
          <div className="py-5">
            <div className="swiper swiper-container swiper--carousel--clients">
              <div className="swiper-wrapper swiper-wrapper--linear align-items-center">
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="abaco"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/abaco.jpg"
                    alt="Abaco Systems"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="georges"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/georges.jpg"
                    alt="Georges at the Cove"
                    width="262"
                    height="25"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="fleet"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/fleet.jpg"
                    alt="RHFleet"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="foresight"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/foresight.jpg"
                ...
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="ge"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/ge.jpg"
                    alt="GE"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    ...
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/headquarters.jpg"
                    alt="The Headquarters"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="mcasd"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/mcsd.jpg"
                    alt="Museum of Contemporary Art San Diego"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="seaport"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/seaport.jpg"
                    alt="Seaport Village"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="electra"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/electra.jpg"
                    alt="Electra Bikes"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="spotlink"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/spotlink.jpg"
                    alt="Spotlink"
                  />
                </div>
                <div className="swiper-slide flex-shrink-1">
                  <img
                    className="warwicks"
                    src="https://res.cloudinary.com/gcmcafee/image/upload/f_auto/v1659859196/portfolio/clients/warwicks.jpg"
                    alt="Warwicks"
                  />
                </div>
              </div>
        ...
        <section
          id="contact"
          className="contact min-vh-lg-100 D Flex align-items-center text-center border-bottom border-1 border-dark position-relative"
        >
          <div className="title-wrapper">
          ...
          <div className="py-5 py-lg-7 container-fluid content">
            ...
            <form action="https://formspree.io/f/mpzkvljk" method="POST" className="text-start">
